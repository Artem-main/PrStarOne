package realpostgres.services;

import realpostgres.repository.Dog;
import realpostgres.repository.Repository;
import realpostgres.repository.User;
...
public class DogsAppServices {
    ...
    public List<String> getTopWalkingUsers() {
