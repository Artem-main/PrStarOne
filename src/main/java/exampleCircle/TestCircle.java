...
import exampleCircle.circle.Circle;
...
public class TestCircle {
    ...
    private void testRadiusMoreNull () {
        Circle circle = new Circle(0);
        if (circle.getRadius() > 0) {
            System.out.println("testRadiusMoreNull: OK");
        } else {
            System.out.println("testRadiusMoreNull: FAILURE");
        }
    }
    public void test() {
        testCreateCircle();
